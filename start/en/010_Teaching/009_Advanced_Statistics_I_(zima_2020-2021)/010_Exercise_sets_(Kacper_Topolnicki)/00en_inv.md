...
- sample script with statistical tests for checking if
  ...
  - [script](./start/en/010_Teaching/009_Advanced_Statistics_I_(zima_2020-2021)/010_Exercise_sets_(Kacper_Topolnicki)/006_Set_6_(29_III_2021)/set_5.py) with some useful examples
  - [line by line](./start/en/010_Teaching/009_Advanced_Statistics_I_(zima_2020-2021)/010_Exercise_sets_(Kacper_Topolnicki)/006_Set_6_(29_III_2021)/set_5.pdf) guide to the script (I suggest that you read this first)
