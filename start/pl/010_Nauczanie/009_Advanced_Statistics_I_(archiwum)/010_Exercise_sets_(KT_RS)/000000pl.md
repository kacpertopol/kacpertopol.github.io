...
- simple plotting
  - [script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/plots.py) with simple plots
  - [line by line](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/plots.pdf) guide to the script (I suggest that you read this first)
    - some comments in the guide do not apply to *Windows*
- numerical integration
  - [script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/integrals.py)
  - [line by line](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/integrals.pdf) guide to the script (I suggest that you read this first)
    - some comments in the guide do not apply to *Windows*
- `csv` import and export
  - [script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/numpycsv.py)
  - [line by line](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/numpycsv.pdf) guide to the script (I suggest that you read this first)
    - some comments in the guide do not apply to *Windows*
- additional links
...
Download the [basic script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/basic_example.py).
...
Download the [more complicated example](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/001_Set_1_(25_I_2021)/more_complex_example.zip).
...
- simple plotting
  - [script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/002_Set_2_(1_III_2021)/set_2.py) with some usefull examples
  - [line by line](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/002_Set_2_(1_III_2021)/set_2.pdf) guide to the script (I suggest that you read this first)
    - some comments in the guide do not apply to *Windows*
...
- simpe de-noising, background removal
  - [script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/003_Set_3_(8_III_2021)/set_3.py) with some useful examples
  - [sample image](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/003_Set_3_(8_III_2021)/sample_image.png) with some useful examples
  - [line by line](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/003_Set_3_(8_III_2021)/set_3.pdf) guide to the script (I suggest that you read this first)
    - some comments in the guide do not apply to *Windows*
  - [module template](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/003_Set_3_(8_III_2021)/module_template.py)
...
[tip](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/003_Set_3_(8_III_2021)/module_template.py)
...
- regular expressions
  - [script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/004_Set_4_(15_III_2021)/set_4.py) with a simple example
  - [line by line](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/004_Set_4_(15_III_2021)/set_4.pdf) guide to the script
...
Have a look at the [script from the previous set](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/004_Set_4_(15_III_2021)/../003_Set_3_(8_III_2021)/set_3.py)
...
- sample script with statistical tests for checking if
  ...
  - [script](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/006_Set_6_(11_IV_2021)/set_5.py) with some useful examples
  - [line by line](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/006_Set_6_(11_IV_2021)/set_5.pdf) guide to the script (I suggest that you read this first)
...
- Mathematica [notebook](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/010_Set_10_(31_V_2021)/hdpr.nb) and [pdf](./start/pl/010_Nauczanie/009_Advanced_Statistics_I_(archiwum)/010_Exercise_sets_(KT_RS)/010_Set_10_(31_V_2021)/hdpr.pdf).
